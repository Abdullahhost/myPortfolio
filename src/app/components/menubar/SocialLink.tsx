...
const SocialLink: React.FC<ISocialLinkProps> = ({
    ...
    return (
        <div className="p-3 group border-2 cursor-pointer border-neutral-600 bg-black rounded-full relative" ref={buttonRef} onMouseMove={(e) => handleMouseMove(e, buttonRef, textRef)} onMouseOut={(e) => handleMouseOut(e, buttonRef, textRef)} onClick={() => router.push(linkUrl)} title={linkName} >
